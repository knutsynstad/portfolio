...
const data = {
    ...
    description: (
        <>
            <p>
                When tasked to redesign a book of my choosing, I found it was
                going to be necessary to select a book with strong subject
                matter, yet suffered from a lack of typographical
                sophistication. This endeavor proved to be more challenging than
                initially thought, as there was no shortage of books needing
                assistance and I was faced with a multitude of possibilities as
                vast as the San Francisco library&apos;s card catalog.
            </p>
            <p>
                Ultimately, I selected a book by Life magazine, which showcased
                100 people who changed the world through bold and experimental
                means. It was in this same manner that I wanted to convey the
                powerful history behind these remarkable figures and their
                extraordinary contributions, while still honoring the
                journalistic appeal of the publication&apos;s past.
            </p>
        </>
    ),
};
