...
const data = {
    ...
    description: (
        <>
            <p>
                Of Errol Morris, Roger Ebert once said, “After twenty years of
                reviewing films, I haven&apos;t found another filmmaker who
                intrigues me more… Morris is like a magician, and as great a
                filmmaker as Hitchcock or Fellini.” With documentaries such as
                The Fog of War and The Thin Blue Line, Morris helped spur a
                rebirth of non-fiction film, exploring a wide range of subjects
                and politically charged themes, that garnered him both wide
                critical acclaim as well as scrutiny.
            </p>
            <p>
                My objective in creating a film festival around Errol Morris
                required selecting films which share a common thread, while
                developing a system and design language to promote said event.
                The Margin of Error was an examination of truth&apos;s
                subjective nature and the injustice that results from its
                varying interpretations by the entities within his films.
            </p>
        </>
    ),
};
