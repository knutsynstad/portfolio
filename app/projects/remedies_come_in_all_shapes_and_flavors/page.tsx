...
const data = {
    ...
    description: (
        <>
            <p>
                Delicatessens in San Francisco are a dime a dozen.
                Unfortunately, most don&apos;t have the budget to obtain design
                services that would help separate them from the crowd and speak
                to the quality of their establishment. My objective was to
                select an existing local company that could benefit from
                stronger design, in an effort to strengthen their brand equity
                and create a niche market.
            </p>
            <p>
                After a fair amount of research, I learned of a neighborhood
                deli in the Lower Haight with an amazing story. Staples of their
                community for over 22 years, Jack and Margaret Chang have had
                numerous articles published about their discovery of a
                miraculous concoction rooted in peanut milk. Nutritious, yet
                easy on the body many have claimed it has helped them deal with,
                and overcome, a wide array of diseases. The wall in their little
                deli, full of customer testimonials, is proof to how well it has
                been received. It was this rich history and commitment to their
                customers that made for a great starting point for brand
                development. In a city where the bar is set high for food
                standards and healthful ingredients, it made sense that the
                Earthnuts&apos; brand would revolve around their specialty
