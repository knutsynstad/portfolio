...
const data = {
    ...
    title: "Automating your Reddit workflows.",
    description: (
        <>
            <p>
                {/* Context */}
...
const Project = () => (
    <ProjectDetailsPage data={data}>
        ...
        <Slideshow>
            <Slide>
                <Image src={AutomationsEmptyState} alt={data.title} />
            </Slide>
            <Slide>
                <Image src={AutomationsChangingTheName} alt={data.title} />
            </Slide>
            <Slide>
                <Image src={AutomationsSelectTrigger} alt={data.title} />
            </Slide>
            <Slide>
                <Image src={AutomationsTimelineWithTrigger} alt={data.title} />
            </Slide>
            <Slide>
                <Image src={AutomationsAddAStep} alt={data.title} />
            </Slide>
            <Slide>
                <Image src={AutomationsEmptyMessage} alt={data.title} />
            </Slide>
            <Slide>
                <Image src={AutomationsPopulatedMessage} alt={data.title} />
            </Slide>
        </Slideshow>
        ...
        <Slideshow>
            <Slide>
                <Image src={AutomationsListPopulated} alt={data.title} />
            </Slide>
            <Slide>
                <Image src={AutomationsListEmpty} alt={data.title} />
            </Slide>
        </Slideshow>
        ...
        <div className="grid grid-cols-12 gap-8 mt-32">
            ...
            <p className="col-start-1 col-span-7">
                ...
                readily resonates and facilitates comprehension. Once the
                triggering event takes place, the steps are performed
                sequentially, without branching. Add as many steps as needed.
            </p>
        </div>
        <Image src={AutomationsStepsLinear} alt="Model: Step Count" className="rounded-2xl" />

        <div className="grid grid-cols-12 gap-8 mt-32">
            <h2 className="col-start-1 col-span-7">Steps are extensible</h2>
            <p className="col-start-1 col-span-7">
                Steps possess the capability to invoke actions as well as halt
                the progression of the automation. These steps can be arranged
                in a flexible manner, allowing for uninhibited composition. The
                inherent potency of Automations lies in their elemental
                simplicity and the versatile manner in which they can be
                combined.
            </p>
        </div>
        ...
        <div className="grid grid-cols-12 gap-8 mt-32">
            ...
            <p className="col-start-1 col-span-7">
                Some steps might necessitate configuration. Hence a UI
                accommodating both instances where no configuration is needed,
                as well as scenarios involving configurations with unspecified
                data structures. This wrapper must possess remarkable
                versatility, while minimizing the effort involved in
                constructing and maintaining an expanding collection of steps.
            </p>
            <p className="col-start-1 col-span-7">
        ...
        <div className="grid grid-cols-12 gap-8 mt-32">
            ...
            <p className="col-start-1 col-span-7">
                ...
                controls are revealed progressively as the user makes
                selections. This allows for a more focused experience and
                reduces the cognitive load associated with a large number of
                controls.
            </p>
        </div>
        ...
        <div className="grid grid-cols-12 gap-8 mt-32">
            ...
            <p className="col-start-1 col-span-7">
                ...
                variety of data types and use cases. Rooted in Reddit&apos;s
                design system, Reddit Product Language, to ensure consistency,
