  ...
  description: (
    <>
      <p>
        ...
        spends millions of dollars predicting national crop production
        throughout the growing season. Helped by thousands, they sample farms,
        by hand, in a portion of the 3,242 counties. Their monthly reports move
        commodity crop markets—having this information before others provide a
      ...
      <p>
        ...
        prediction came within 1.9% of the actual production, reported by the
        USDA more than 6 months later.
      </p>
