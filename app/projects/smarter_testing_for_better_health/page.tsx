...
const data = {
  ...
  description: (
    <>
      <p>
        Adaptive Sensory Technology (AST), a spinout from Harvard Medical
        School, is developing advanced, quantitative tools for detecting changes
        in functional vision. Their research began over a decade earlier as a
        lab project in basic vision science to improve how vision changes are
        detected in research experiments. AST&apos;s Quick Contrast Sensitivity
        Function (qCSF) method brings a new level of precision to vision
        assessment and has been applied to measure contrast sensitivity deficits
        in low vision, age-related macular degeneration, retinitis pigmentosa,
        glaucoma, multiple sclerosis, amblyopia, congenital and adult cataract,
        and Fabry&apos;s disease.
      </p>
      <p>
        ...
        manifested in a dynamic identity that, like their technology,
        continuously evolves and is unique every time.
      </p>
    </>
  ),
};
