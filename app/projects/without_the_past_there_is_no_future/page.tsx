...
const data = {
    ...
    description: (
        <>
            <p>
                “Without the past, there is no future.” The origin of this
                phrase remains a mystery, but the message is clear―understanding
                where we are going comes from knowing where we&apos;ve been.
                Stories of one&apos;s family heritage are passed down from
                generation to generation, but as with all storytelling, details
                are often lost along the way.
            </p>
            <p>
                Technology has changed how we go about discovering our
                family&apos;s history and reconnecting with our past. In fact,
                in the digital age it&apos;s never been easier to organize and
                document memories. Now, with the help of Befør, Norwegian
                Americans have the unique opportunity to tell their
                family&apos;s story in a medium that can be preserved and shared
