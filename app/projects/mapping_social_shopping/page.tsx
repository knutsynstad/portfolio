  ...
  description: (
    <>
      <p>
        ...
        has a long history of pioneering approaches for taming complexity. One
        of the artifacts to emerge from the practice is the Application Map. In
        1998, Hugh Dubberly, inspired by Paul Souza&apos;s work for the original
        NOVA TV series, engaged Paul Khan and Krzysztof Lenk to map the Netscape
        website. Since then the artifact has reached maturity through iteration
        and definition.
      </p>
      <p>
        ...
        looking through the viewport, you can only see one screen at a time.
        That means it&apos;s difficult to immediately understand the scale and
        scope of an application, and it can be hard to know if you&apos;ve
        visited every screen or seen every case. A way to bypass this is to
        create an application flow map; a single document which captures and
        presents every screen within an application and shows how they&apos;re
        connected.”
      </p>
      <p>
