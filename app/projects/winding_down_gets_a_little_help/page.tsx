...
const data = {
    ...
    description: (
        <>
            <p>
                In today&apos;s marketplace, a brand is no longer simply a logo,
                but instead an highly considered and orchestrated set of
                elements meant to reach an audience—not on a visual level—but on
                an emotional one. My given objective was to choose a dead, dying
                or defunct brand and move beyond simply creating an identity
                system but to reinforce the nuances that constitute a holistic
                branding effort.
            </p>
            <p>
                Few whiskey companies can compare to the history of The Seagram
                Company. Founded in 1857, Seagram&apos;s rose to become the
                largest distiller of whiskey in the world by 1989. It was only
                after a shift in priority of company holdings and a series of
                management missteps that the brand was sent into a downward
                spiral from which they could no longer recover.
            </p>
            <p>
                Born a whiskey distiller and fell an investment company,
                Seagram&apos;s lost sight of what made them great. Contrary to
                popular belief, Seagram&apos;s wasn&apos;t selling whiskey, but
                a state of relaxation. By expanding the context of relaxation,
                this project aims to show how Seagram&apos;s can interject
                itself into new and previously overlooked segments to reacquire
                market appeal.
            </p>
        </>
    ),
