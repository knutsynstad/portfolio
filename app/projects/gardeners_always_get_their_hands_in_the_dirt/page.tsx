...
const data = {
    ...
    description: (
        <>
            <p>
                The French Paper Company has been environmentally conscious
                since the very beginning. The hydro-generators, that power every
                aspect of their daily processes, were installed in 1922, long
                before it was PC or made for good PR. French Paper is also a
                pioneer when it comes to recycled paper and offers many
                environmental paper choices.
            </p>
            <p>
                Tasked with assisting a brand enter a new, viable market segment
                where they are not yet established provided a means for which
                French Paper could hypothetically transition into products that
                care for the environment as much as they do. With a deep-seeded
                commitment to the environment at its core, it&apos;s feasible
                that French Paper could launching their own line of gardening
                tools. Such a product line could leverage the company&apos;s
                position and expertise in environmentally friendly and
                sustainable manufacturing in order to provide a line of
