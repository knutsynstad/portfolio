      ...
      <main className="flex flex-col gap-32">
        <figure className="flex flex-col">
          ...
          <figcaption className="grid grid-cols-12">
            ...
            <p className="col-span-7">
              A timelapse of 600 t-SNE iterations. The solution generally
              improves with each iteration. Subject to diminishing returns.
            </p>
          </figcaption>
        </figure>
        ...
        <figure className="flex flex-col gap-8">
          ...
          <figcaption className="grid grid-cols-12">
            ...
            <p className="col-span-7">
              The logos are aligned to a grid. The Linear assignment problem
              (LAP) algorithm is a greedy algorithm, and the solution is not
        ...
        <figure>
          ...
          <figcaption className="grid grid-cols-12">
            ...
            <p className="col-span-7">
              ...
              deterministic, and will vary slightly each time the visualization
              is loaded.
            </p>
          </figcaption>
        </figure>
