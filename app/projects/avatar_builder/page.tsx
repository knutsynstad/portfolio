...
const data = {
    ...
    description: (
        <>
            <p>
                Reddit avatars is a vehicle for personal expression. It&apos;s
                your canvas to do with as you please.
            </p>
            <p>
                The Avatar Builder is a system that allows users to create a
                unique avatar that represents them across the Reddit platform.
                The system is extensible and scalable, allowing for the addition
                of new features and assets over time.
            </p>

            <p>
                Use the builder to assemble your own avatar using
                Snoo—Reddit&apos;s mascot—and visual elements we provide. Your
                avatar is how your appear to others throughout Reddit. We
                embrace the weird.
            </p>
...
const Project = () => (
    <ProjectDetailsPage data={data}>
        <div className="relative bg-black pt-32 pb-32 w-full flex flex-col gap-16">
            <h2 className="text-white">A platform for personal expression and delight.</h2>
