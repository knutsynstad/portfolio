...
const data = {
    ...
    description: (
        <>
		<p>Our body continuously strives to achieve homeostasis. It does so through a number of interlocked biological feedback loops, such as the endocrine system—a collection of glands that produce hormones that regulate metabolism, growth and development, tissue function, sexual function, reproduction, sleep, and mood, among other things.</p>
		<p>The pancreas, an organ of the endocrine system is integral to our control of blood glucose. Diabetes limits its ability to do so. Our various means of blood glucose control can be modeled as a first order control system or feedback loop.
		p The following is a compendium of models on diabetes.</p>
        </>
    ),
};
...
const slides = [
    ...
    [Diabetes_Mechanical_Thermostat, `An example:
    mechanical thermostat`],
    [Diabetes_Healthy_Person, "Healthy person"],
    [Diabetes_Manual_Injections, "Person with diabetes making manual injections"],
    [Diabetes_Artificial_Pancreas, "Person with diabetes and an artificial pancreas"],
    [Diabetes_Physiological_Feedback_Loop, "Physiological feedback loop (with artificial control system)"],
    [Diabetes_Augmented_Data, "Physiological feedback loop augmented by behavioral and environmental data"],
    [Diabetes_Interacting_Feedback_Loops, "Feedback loops are not isolated and naturally interact; emerging systems promise to address this complexity."],
];
